	  ...
	  <div class="item-box" id="crop-avatar">

		    <!-- Current avatar -->
		    <div class="avatar-view thumbnail-hover" title="Change the avatar">
		      <img id="myImg" src="${myPicture?if_exists}" alt="Avatar">
		    </div>
		              ...
		              <div class="avatar-body">
		                ...
		                <div class="row">
		                  <div class="col-md-12">
		                    ...
		                    <#if myPicture??>
		                    	<img id="profileImg" src="${myPicture?if_exists}" style="width: 50%; margin-left: auto;margin-right: auto">
		                    <#else>
		                ...
		                <div class="row avatar-btns">
		                  <div class="col-md-12">
		                    ...
		                    <div class="btn-group">
		                    	<button type="button" class="btn btn-primary btn-block avatar-save" data-dismiss="modal" onclick="javascript: uploadImg();"><span class="glyphicon glyphicon-picture"></span> <@spring.message "picture.button.upload"/></button>
		                    </div>
		                  </div>
		                </div>
