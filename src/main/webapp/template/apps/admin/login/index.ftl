...
.bgIndex {
	// position: relative;
    background: url('${configBean.contextPath?if_exists}/static/apps/img/bi02.png') no-repeat center center fixed;
			...
			<div class="col-sm-12">
				<form class="form-signin" role="form" action="login" name="sform" id="sform" method="POST">
			        ...
			        <input type="password" name="userPwd" class="form-control" placeholder="password" required>
			  	    ...
			  	    <div class="checkbox"><a href="${configBean.baseURL?if_exists}/login/introResetPwd"><@spring.message "login.forgot.password"/></a></div>
...
<#--
			<div class="col-sm-6">
			    <form class="form-signin" role="form" action="introSingup" method="POST">
