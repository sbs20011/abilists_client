...
<div class="row">
	<div class="col-md-12">
		...
		<form name="newFormId" class="form-horizontal" action="${configBean.baseURL?if_exists}/works/istProjectTech" method="post" onkeypress="return captureReturnKey(event);">
	    ...
	    <#list model.userProjectTechList as userProjectTech>
			<ul class="bgrow nthrow item-box ul-table" onmouseover="overChangeColor(this);" onmouseout="outChangeColor(this);" 
				onclick="sltUserProjectTech(this, '${userProjectTech.uptNo?if_exists}', '${userProjectTech.mtNo?if_exists}', skillsList);">
